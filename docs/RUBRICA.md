...
|---|---:|---|---|---|
| Selección y preparación | 2 | Notebooks 01–04 | `src/preprocessing.py`, `src/enrichment.py`; limpieza, EDA con distribuciones/correlaciones/segmentos antes del recorte y muestreo por clave (deck 06, págs. 9–13) | 5 tablas silver; 7 gold base; 29,314 restaurantes; 2.67M reseñas; densidad 0.011%; diámetro ≥10 |
| Grafos y ranking | 4 | Notebook 05 | `src/graphs.py`; PageRank (deck 07, págs. 18–32), HITS (deck 07, pág. 40 + MMDS cap. 5), Girvan–Newman y modularidad (deck 12, págs. 9–34) | PageRank/HITS en ambos grafos; 33 comunidades, 4 grandes caracterizadas (tamaño, densidad interna, nodos clave y conexiones inter-comunidad vía conductancia + matriz de mezcla); Q(CNM)=0.396 vs Q(GN)=0.294; 3 tablas y 5 figuras |
